...
class Dataset(object):
    ...
    def load_annotations(self, dataset_type):
        ...
        with open(self.annot_path, 'r') as f:
            txt = f.readlines()
            txt = [line.replace('YiZhuangDaLuWang/',
                                '/media/jiangshengjie/Elements/New_yizhuang_MC3D/home/wangning/Desktop/data/New_yizhuang/YiZhuangDaLuWang/')
                   for line in txt]
            txt = [line.strip() for line in txt]
            txt = txt[0:2850]
        for mc3d_label in txt:
            try:
                with open(mc3d_label, 'r') as f_new:
                    mc3d_annotation = f_new.readlines()
                    mc3d_annotation = [line.replace('New_yizhuang/YiZhuangDaLuWang/',
                                                    '/media/jiangshengjie/Elements/New_yizhuang_MC3D/home/wangning/Desktop/data/New_yizhuang/YiZhuangDaLuWang/')
                                       for line in mc3d_annotation]
                    mc3d_annotation = [line.strip() for line in mc3d_annotation]
                    annotations = annotations + mc3d_annotation
            except:
                continue
